...
$defParams = @{
    Name = "AppendCommandTagToVirtualMachines"
...
$defParams = @{
    Name = "AppendSecurityOwnerTagToVirtualMachines"
...
$initiativeParams = @{
    Name = "AppendTagsToVirtualMachines"
    DisplayName = "Append Tags Set for VMs"
    Description = "Append Tags to VMs"
    Metadata = '{"category":"Tags"}'
    Parameter = '{"USNTagCode": { "type": "string" }, "SecurityOwner": { "type": "string" }}'
...
$assignParams = @{
    Name = "SecTagsVirtualMachines"
    DisplayName = "Security Tags for Virtual Machines"
